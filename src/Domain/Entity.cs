...
public abstract class Entity<T> : IEntity<T> where T : IEquatable<T>, IComparable<T>
{
   ...
   /// <summary>Defines the equality operator for comparing two entities of the same type. This operator evaluates whether two entities are equal based on their unique identifiers. If both entities are null, it returns true. If only one entity is null, it returns false. If neither is null, their IDs are compared to determine equality.</summary>
   ...
   /// <summary>Defines the inequality operator for comparing two entities of the same type. This operator evaluates whether two entities are not equal based on their unique identifiers. If both entities are null, it returns false. If only one entity is null, it returns true. If neither is null, their IDs are compared to determine inequality.</summary>
   /// <param name="left">The first entity to compare.</param>
   /// <param name="right">The second entity to compare.</param>
   ...
   /// <summary>Returns the hash code for the entity. The hash code is derived from the entity's unique identifier if it exists. If the entity is transient (does not have a valid identifier), the base hash code is used.</summary>
   ...
   /// <summary>Determines whether the current entity is equal to another object. The equality comparison is based on the unique identifier of the entity.</summary>
